 ...
 */
class getRouting_LoaderService extends App_KernelDevlsDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\Routing\AnnotatedRouteControllerLoader(($container->privates['annotations.cached_reader'] ?? $container->getAnnotations_CachedReaderService()), 'devls');

        $a->addLoader(new \Symfony\Component\Routing\Loader\XmlFileLoader($b, 'devls'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\YamlFileLoader($b, 'devls'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\PhpFileLoader($b, 'devls'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\GlobFileLoader($b, 'devls'));
        $a->addLoader(new \Symfony\Component\Routing\Loader\DirectoryLoader($b, 'devls'));
